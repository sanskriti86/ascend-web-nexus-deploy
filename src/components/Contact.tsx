            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h5 className="text-base font-semibold text-gray-900">Phone</h5>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h5 className="text-base font-semibold text-gray-900">Address</h5>
                    <p className="text-gray-700">123 Digital Avenue, Tech City, 12345</p>
                  </div>
                </div>
              </div>
